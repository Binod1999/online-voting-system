...
$name3 = mysqli_real_escape_string($con,$_POST['voteid']);
...
$sql = mysqli_query($con, 'INSERT INTO voters(firstname,lastname,username,voterID,voteimg)
         VALUES("'.$_POST['firstname'].'","'.$_POST['lastname'].'","'.$_POST['username'].'","'.$_POST['voteid'].'","'.$folder.'")');
		 if (!$sql) { 
...
echo "<center><h1>Successfully Registered!</h1>  <br><a href= 'login.php'>Click here to Login </a></center>";
